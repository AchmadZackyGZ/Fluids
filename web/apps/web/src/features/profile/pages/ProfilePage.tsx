        ...
        <div className="space-y-6">
          ...
          <nav className="space-y-1.5">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 font-medium text-sm transition-all"
            >
              ...
              <div className="relative flex-shrink-0">
                {user.avatarUrl ? (
                  <img
                    src={user.avatarUrl}
                    alt={displayName}
                    className="w-24 h-24 rounded-2xl object-cover border-2 border-[#00f0ff] shadow-[0_0_25px_rgba(0,240,255,0.4)]"
                  />
                ) : (
                  <div className="w-24 h-24 rounded-2xl bg-gradient-to-tr from-[#00f0ff] to-[#9d00ff] p-0.5 shadow-[0_0_25px_rgba(0,240,255,0.4)]">
